...
comment5 = Comment.create(body: "Looks like MC Hammer was desparate for money", author_id: marshall.id, video_id: cheetos.id)
...
comment10 = Comment.create(body: "shut up golffluclinic", author_id: j.id, video_id: diabeetus.id, parent_comment_id: comment9.id)
...
comment14 = Comment.create(body: "my therapist recommended i switch to direct tv so i could watch more tv and get away from my family", author_id: brad.id, video_id: direct_tv.id)
comment15 = Comment.create(body: "im more of a mr pibb guy", author_id: brad.id, video_id: drpepper.id)
comment16 = Comment.create(body: "these are the dumbest ads", author_id: j.id, video_id: drpepper.id)
comment17 = Comment.create(body: "bigfoot is real man ive seen him", author_id: chris.id, video_id: drpepper.id)
comment18 = Comment.create(body: "you probably just saw a deer or something", author_id: omar.id, video_id: drpepper.id, parent_comment_id: comment17.id)
comment19 = Comment.create(body: "you think the lochness monster is real too?", author_id: brad.id, video_id: direct_tv.id, parent_comment_id: comment17.id)
...
comment27 = Comment.create(body: "I miss chappelle show", author_id: brad.id, video_id: expedia.id, parent_comment_id: comment23.id)
...
comment29 = Comment.create(body: "is that still on?", author_id: brad.id, video_id: expedia.id, parent_comment_id: comment28.id)
comment30 = Comment.create(body: "yup. season 11", author_id: tom.id, video_id: expedia.id, parent_comment_id: comment28.id)
comment31 = Comment.create(body: "wow. i remember when the first episode aired. I'm getting old", author_id: brad.id, video_id: expedia.id, parent_comment_id: comment28.id)
comment32 = Comment.create(body: "how did I end up here?", author_id: bill.id, video_id: expedia.id)
comment33 = Comment.create(body: "if only all politicians were like pinocchio", author_id: joe.id, video_id: geico.id)
comment34 = Comment.create(body: "no politics here. i just want to watch ads", author_id: hayden.id, video_id: geico.id)
comment35 = Comment.create(body: "I love the guy in the front row shaking his head :'-)", author_id: marshall.id, video_id: geico.id)
comment36 = Comment.create(body: "its sad that people will believe anything someone else tells them without thinking for themselves", author_id: bill.id, video_id: geico.id, parent_comment_id: comment33.id)
comment37 = Comment.create(body: "I said no politics!", author_id: hayden.id, video_id: geico.id, parent_comment_id: comment33.id)
...
comment40 = Comment.create(body: "not as good as the original", author_id: hayden.id, video_id: geico_sequel.id)
...
comment43 = Comment.create(body: "this game is so addicting", author_id: joe.id, video_id: gta.id)
comment44 = Comment.create(body: "i dont really play video games so i have no idea why i'm watching this", author_id: brad.id, video_id: gta.id)
...
comment47 = Comment.create(body: "uhhhhhh.....wat???", author_id: tom.id, video_id: jgwentworth.id, parent_comment_id: comment46.id)
...
comment49 = Comment.create(body: "this. is. disturbing.", author_id: j.id, video_id: kfc.id)
...
comment53 = Comment.create(body: "chance the rapper kinda sucks", author_id: omar.id, video_id: kitkat.id)
comment54 = Comment.create(body: "that ed sheeran song cross me is alright", author_id: j.id, video_id: kitkat.id)
comment55 = Comment.create(body: "my name is brad", author_id: brad.id, video_id: liberty_mutual.id)
comment56 = Comment.create(body: "my mom loves this ad", author_id: tom.id, video_id: liberty_mutual.id)
...
comment60 = Comment.create(body: "we DEFINITELY didn't ask for it", author_id: brad.id, video_id: pizzahut.id)
comment61 = Comment.create(body: "this is giving me diarrhea just by watching", author_id: j.id, video_id: pizzahut.id)
comment62 = Comment.create(body: "is it bad that i kind of want to try it though...", author_id: julio.id, video_id: pizzahut.id)
comment63 = Comment.create(body: "cats > dogs", author_id: bill.id, video_id: sheba.id)
comment64 = Comment.create(body: "I'm more of a dog person", author_id: brad.id, video_id: sheba.id)
...
comment67 = Comment.create(body: "¿Por qué subiste esto?", author_id: omar.id, video_id: sprint.id)
...
comment69 = Comment.create(body: "dogs > cats", author_id: tom.id, video_id: subaru.id)
comment69 = Comment.create(body: "this is why i bought a subaru", author_id: bill.id, video_id: subaru.id)
comment70 = Comment.create(body: "[insert lame dog pun here]", author_id: michelle.id, video_id: subaru.id)
comment71 = Comment.create(body: "CLASSIC!", author_id: brad.id, video_id: taco_bell.id)
